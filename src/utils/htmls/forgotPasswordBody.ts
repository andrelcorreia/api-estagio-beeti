...
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Notificação de Lembrete de Manutenção</title>
<style>
body {
  background-color: #181818;
  color: white;
...
<div class="container">
  ...
  <h1>Notificação de lembrete da manutenção</h1>
  <p>Lembrete da manutenção marcada faltando 1 dia antes de fechar, com o cliente: ${cli_name} no produto: ${prod_name}.</p>
</div>
</body>
</html>
`;
...
export { ForgotPasswordBody, ReminderBody };
